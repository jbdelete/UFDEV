...
if(status == 0)
	fprintf('Plot to File - Could Not Create Directory %s - Aborting\r\n',Directory);
	return
end
ltx = fopen (latex_fl, "w", "ieee-le");
if(ltx<0)
	fprintf('Plot to File - Could Not Create File %s - Aborting\r\n',latex_fl);
	return
end
...
if 1
    ...
    if(pltx<0)
        fprintf('PlotToFileDir - Could Not Create File %s - Aborting\r\n','..\rpt\pre.tex');
        return
    end
