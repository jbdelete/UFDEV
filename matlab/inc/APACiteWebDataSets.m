...
function ret = APACiteWebDataSets(Name,Organization,Title,Date,DateAccessed,WebSite)
	...
	fprintf(ptx,'============================================= APACiteWebDataSets %s \r\n',Name);
	...
	fprintf(ltx,'Date accessed %s, ',DateAccessed);
